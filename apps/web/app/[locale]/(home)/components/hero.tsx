  ...
  const cards = [
    {
      ...
      title: "Arbiscan",
      description:
        home?.showcase?.arbiscanDescription ||
        "On-chain verification via Arbitrum One",
      color: "bg-white",
      type: "arbiscan",
      headerBg: "bg-gray-50",
    ...
    },
    {
      ...
      description:
        home?.showcase?.whitepaperDescription ||
  ...
  return (
    <div className="w-full relative overflow-hidden text-white">
      <GridPattern
        ...
        strokeDasharray={"4 2"}
        className={cn(
          "mask-[radial-gradient(ellipse_at_center,white,transparent_50%)] z-0 opacity-20"
        )}
      />
